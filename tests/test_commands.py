...
def test_find_tabular_dashboard_success(ldi_resources, capsys):
    ...
    reference_table = """
| Type       | Name                             | Title                            | Folder    | UID       | Created              | Updated              | Created by   | Datasources                                                                           | URL                                                                 | Matches                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|:-----------|:---------------------------------|:---------------------------------|:----------|:----------|:---------------------|:---------------------|:-------------|:--------------------------------------------------------------------------------------|:--------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Dashboards | luftdaten-info-generic-trend-v27 | luftdaten.info generic trend v27 | Testdrive | ioUrPwQiz | xxxx-xx-xxTxx:xx:xxZ | xxxx-xx-xxTxx:xx:xxZ | admin        | -- Grafana --,ldi_v2,weatherbase                                                      | http://localhost:33333/d/ioUrPwQiz/luftdaten-info-generic-trend-v27 | [{'path': 'dashboard.panels.[1].targets.[0].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[1].targets.[1].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[1].targets.[2].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[1].targets.[3].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[1].targets.[4].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[3].targets.[0].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[4].targets.[0].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[5].targets.[0].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[6].targets.[0].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[7].panels.[0].targets.[0].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[7].panels.[0].targets.[1].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[7].panels.[1].targets.[0].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[7].panels.[1].targets.[1].measurement', 'value': 'ldi_readings'}] |
| Dashboards | luftdaten-info-generic-trend-v33 | luftdaten.info generic trend v33 | Testdrive | jpVsQxRja | xxxx-xx-xxTxx:xx:xxZ | xxxx-xx-xxTxx:xx:xxZ | admin        | -- Grafana --,{'type': 'influxdb', 'uid': 'PDF2762CDFF14A314'},{'uid': 'weatherbase'} | http://localhost:33333/d/jpVsQxRja/luftdaten-info-generic-trend-v33 | [{'path': 'dashboard.panels.[1].targets.[0].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[1].targets.[1].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[1].targets.[2].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[1].targets.[3].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[1].targets.[4].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[3].targets.[0].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[4].targets.[0].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[5].targets.[0].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[6].targets.[0].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[7].panels.[0].targets.[0].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[7].panels.[0].targets.[1].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[7].panels.[1].targets.[0].measurement', 'value': 'ldi_readings'}, {'path': 'dashboard.panels.[7].panels.[1].targets.[1].measurement', 'value': 'ldi_readings'}] |
    """.strip()  # noqa: E501
